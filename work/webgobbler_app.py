...
class wg_application:
    ...
    def _setCollectorStatus(self,collectorName,status,information):
        ...
        elif collectorName == "collector_askjeevesimages" : widgets = (self.askJeevesStatus,self.askJeevesInfo)
    ...
    def _updateCollectorStatus(self):
        ...
        visitedCollectors = { "collector_googleimages": False,
                               "collector_askjeevesimages": False,
    ...
    def _initializeGUI(self):
        ...
        # The AskJeeves status:
        Tkinter.Label(self.statusFrame,text='AskJeeves',anchor='w',bd=1,relief='sunken',font=smallFontBold).grid(column=0,row=2,sticky='ew')
        self.askJeevesStatus = Tkinter.Label(self.statusFrame,text="Off",anchor='w',bd=1,relief='sunken',font=smallFont); self.askJeevesStatus.grid(column=1,row=2,sticky='ew')
        self.askJeevesInfo = Tkinter.Label(self.statusFrame,text="",anchor='w',bd=1,relief='sunken',font=smallFont); self.askJeevesInfo.grid(column=2,row=2,sticky='ew')
